...
export default function TopNav() {
  const linkClass = ({ isActive }) => 
    `font-sans text-lg font-medium transition-colors duration-200 px-2 py-1 ${
      isActive 
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm h-20">
      <div className="max-w-7xl mx-auto px-10 h-full flex items-center justify-between">
        {/* LEFT — Logo */}
        <NavLink to="/" className="font-heading text-3xl font-bold text-blue-600 tracking-tight">
          ROAMLY
        </NavLink>
        ...
        <div className="flex items-center gap-10">
          ...
          <NavLink to="/wifi" className={linkClass}>
            WiFi
          </NavLink>
